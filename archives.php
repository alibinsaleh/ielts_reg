<?php 
    ...
    $subscribers = list_subscribers(1);
...
?>
        ...
        <div class="top-content">
            ...
            <div class="inner-bg">
                <div class="container">
                    <div class="row">
                        <h1 class="content-head"><?php echo 'Number of subscribers: ' . count_subscribers(1); ?></h1>
                    </div>
                    <div class="row">
                        <div class="text mytable table-responsive">
                            <table class="table">
                                ...
                                <?php foreach ($subscribers as $subscriber) : ?>
                                    ...
                                    <tr>
                                        <td><button class="btn btn-danger" onclick="move_to_unarchived(<?php echo $subscriber['id']; ?>)">Unarchive</button></td>
                                        <td><?php echo $i; ?></td>
